...
/* check if the config defines are alright */
    ...
    #endif
#elif defined(__circle__)|| defined(__raspberrypi__)
...
/*== LINUX ==================================================================*/
#if (defined(__linux__) || defined(__unix__)) && !defined(__EMSCRIPTEN__) && !defined(__ANDROID__) && !defined(__raspberrypi__) 
#define GL_GLEXT_PROTOTYPES
#include <X11/X.h>
#include <X11/Xlib.h>
